      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-6 md:mb-0">
            ...
            <a href="#" className="hover:text-primary transition-colors">Manage Subscription</a>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>
            Everything taught within The Real World is for education purposes only. 
            It is up to each student to implement and do the work. The Real World 
            team doesn't guarantee any profits or financial success.
          </p>
          <p className="mt-2">
            © {new Date().getFullYear()} The Real World. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
